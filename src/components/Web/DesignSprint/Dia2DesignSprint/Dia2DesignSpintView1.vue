<script setup lang="ts">
	...
	const newId = () => {
		return `${props.question.content.solutions.content.length + 1}`;
	};
</script>

<template>
	<div class="my-4">
		<div class="pt-2 w-full pb-6" v-for="textarea in props.question.content.solutions.content">
			<p class="pb-1">{{ props.question.content.solutions.title }}  <span v-if="question.isFinished" class="text-xs text-red-500">Esta entrada ya no es editable</span></p>
