...
const props = defineProps({
    svgColorClass: {
        type: String, // El tipo del prop es String para recibir el nombre de la clase CSS
        default: '',  // Valor por defecto si no se proporciona el prop
    },
    height: {
        type: String, // El tipo del prop es String para recibir la altura (puedes usar 'px', 'em', 'rem', etc.)
        default: '100%',
    },
    width: {
        type: String,
...
<template>
    <svg :width="width" :height="height" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="mask0_696_83" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" :width="width" :height="height">
            <rect width="32" height="32" :fill="svgColorClass" />
        </mask>
        <g mask="url(#mask0_696_83)">
